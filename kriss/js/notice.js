function openNotice(){
  const notice_date = "20210416";
  const notice_text = [
      {"date":"2021.04.16", "text":"논문 다운로드 시 간헐적으로 오류가 발생하던 현상을 수정했습니다."},
      ...
      {"date":"2021.02.17", "text":"단어&문장 라벨링 메뉴의 최우선 라벨링 규칙 기능을 추가했습니다.<br>PDF 뷰어 기능을 추가했습니다."},
  ];
