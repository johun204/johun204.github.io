function openNotice(){
  const notice_date = "20210426";
  const notice_text = [
      {"date":"2021.04.26", "text":"첫 방문 시 브라우저 캐시에 저장하여 오프라인 환경에서도 사이트를 이용할 수 있도록 적용했습니다."},
      {"date":"2021.04.22", "text":"DOI 검색 시 한 번 이상 검색된 내용을 DB에 저장하여 응답속도를 개선했습니다."},
